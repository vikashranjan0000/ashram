...
<head>
  ...
  <link rel='stylesheet' href='assets/css/custom/booking.css' media='all' type='text/css' />
</head>
...
<body class="front">
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="header-bg" style="background-image:url(images/banner.jpg)">
        <!-- Gradient overlay -->
        <div id="bookingPageTitleFragmentHolder" class=" header-content">
  ...
  <script src="assets/script/js/booking.js"></script>
