...
!function(e) {
    ...
    SEMICOLON.initialize = {
        ...
        goToTopScroll: function() {
            ...
            V.attr("data-offset"));
            e || (e = 450),
            t.scrollTop() > Number(e) ? V.fadeIn() : V.fadeOut()
        },
        maxHeight: function() {
            if ($.length > 0) {
        ...
        pageTransition: function() {
            ...
            m = " border-color",
            p = ' class="bgcolor"',
            g = ' class="border-color"') : (u = ' style="background-color:' + d + ';"',
            ...
            "2" == l ? c = '<div class="css3-spinner-flipper' + f + '"' + u + "></div>" : "3" == l ? c = '<div class="css3-spinner-double-bounce1' + f + '"' + u + '></div><div class="css3-spinner-double-bounce2' + f + '"' + u + "></div>" : "4" == l ? c = '<div class="css3-spinner-rect1' + f + '"' + u + '></div><div class="css3-spinner-rect2' + f + '"' + u + '></div><div class="css3-spinner-rect3' + f + '"' + u + '></div><div class="css3-spinner-rect4' + f + '"' + u + '></div><div class="css3-spinner-rect5' + f + '"' + u + "></div>" : "5" == l ? c = '<div class="css3-spinner-cube1' + f + '"' + u + '></div><div class="css3-spinner-cube2' + f + '"' + u + "></div>" : "6" == l ? c = '<div class="css3-spinner-scaler' + f + '"' + u + "></div>" : "7" == l ? c = '<div class="css3-spinner-grid-pulse"><div' + p + u + "></div><div" + p + u + "></div><div" + p + u + "></div><div" + p + u + "></div><div" + p + u + "></div><div" + p + u + "></div><div" + p + u + "></div><div" + p + u + "></div><div" + p + u + "></div></div>" : "8" == l ? c = '<div class="css3-spinner-clip-rotate"><div' + g + h + "></div></div>" : "9" == l ? c = '<div class="css3-spinner-ball-rotate"><div' + p + u + "></div><div" + p + u + "></div><div" + p + u + "></div></div>" : "10" == l ? c = '<div class="css3-spinner-zig-zag"><div' + p + u + "></div><div" + p + u + "></div></div>" : "11" == l ? c = '<div class="css3-spinner-triangle-path"><div' + p + u + "></div><div" + p + u + "></div><div" + p + u + "></div></div>" : "12" == l ? c = '<div class="css3-spinner-ball-scale-multiple"><div' + p + u + "></div><div" + p + u + "></div><div" + p + u + "></div></div>" : "13" == l ? c = '<div class="css3-spinner-ball-pulse-sync"><div' + p + u + "></div><div" + p + u + "></div><div" + p + u + "></div></div>" : "14" == l && (c = '<div class="css3-spinner-scale-ripple"><div' + g + h + "></div><div" + g + h + "></div><div" + g + h + "></div></div>"),
            i.animsition({
                inClass: t,
                outClass: s,
                inDuration: Number(n),
        ...
        topScrollOffset: function() {
            var e = 0;
            return !a.hasClass("device-lg") && !a.hasClass("device-md") || SEMICOLON.isMobile.any() ? e = 40 : (e = s.hasClass("sticky-header") ? w.hasClass("dots-menu") ? 100 : 144 : w.hasClass("dots-menu") ? 140 : 184,
    ...
    SEMICOLON.header = {
        ...
        superfish: function() {
            return (a.hasClass("device-lg") || a.hasClass("device-md")) && (e("#primary-menu ul ul, #primary-menu ul .mega-menu-content").css("display", "block"),
            SEMICOLON.header.menuInvert(),
            e("#primary-menu ul ul, #primary-menu ul .mega-menu-content").css("display", "")),
            e().superfish ? (e("body:not(.side-header) #primary-menu > ul, body:not(.side-header) #primary-menu > div > ul, .top-links > ul").superfish({
        ...
        removeStickyness: function() {
            ...
            (a.hasClass("device-xs") || a.hasClass("device-xxs") || a.hasClass("device-sm")) && "undefined" == typeof h && (s.removeClass().addClass(d),
            n.removeClass().addClass(c),
            n.hasClass("force-not-dark") || n.removeClass("not-dark"))
        },
        sideHeader: function() {
            ...
            if (x.length > 0) {
                ...
                x.find("a[data-href]").click(function() {
                    ...
                    if (e(o).length > 0) {
                        ...
                        768 > l || a.hasClass("overlay-menu") ? e("#primary-menu").find("ul.mobile-primary-menu").length > 0 ? e("#primary-menu > ul.mobile-primary-menu, #primary-menu > div > ul.mobile-primary-menu").toggleClass("show", function() {
        ...
        topsocial: function() {
            R.length > 0 && (a.hasClass("device-md") || a.hasClass("device-lg") ? (R.show(),
            R.find("a").css({
                width: 40
            }),
            ...
            a.hasClass("device-xxs") && (R.hide(),
            R.slice(0, 8).show())))
        },
        topsearch: function() {
            e(document).on("click", function(t) {
                e(t.target).closest("#top-search").length || a.toggleClass("top-search-open", !1),
                e(t.target).closest("#top-cart").length || _.toggleClass("top-cart-open", !1),
                e(t.target).closest("#page-menu").length || w.toggleClass("pagemenu-active", !1),
    ...
    SEMICOLON.slider = {
                ...
                L = new Swiper(t.find(".swiper-parent"),{
                    ...
                    onSlideChangeEnd: function(a) {
                        t.find(".swiper-slide").each(function() {
                            ...
                            t.find(".yt-bg-player:not(.customjs)").length > 0 && t.find(".yt-bg-player:not(.customjs)").YTPPause()
                        }),
                        t.find('.swiper-slide:not(".swiper-slide-active")').each(function() {
                            ...
                            t.find(".yt-bg-player:not(.customjs)").length > 0 && t.find(".yt-bg-player:not(.customjs)").getPlayer().seekTo(t.find(".yt-bg-player:not(.customjs)").attr("data-start"))
                        }),
                        ...
                        t.find(".swiper-slide.swiper-slide-active").find(".yt-bg-player:not(.customjs)").length > 0 && t.find(".swiper-slide.swiper-slide-active").find(".yt-bg-player:not(.customjs)").YTPPlay(),
        ...
        sliderParallaxOffset: function() {
            ...
            T.length > 0) {
                ...
                e = t;
            return k.next("#header").length > 0 && (e = 0),
            e
        },
        ...
        headerSchemeChanger: function(t, i) {
            if (t.length > 0) {
                ...
                if (t.hasClass("dark")) {
                    ...
                    s || e("#header.transparent-header.sticky-header,#header.transparent-header.semi-transparent.sticky-header,#header.transparent-header.floating-header.sticky-header").removeClass("dark"),
    ...
    SEMICOLON.portfolio = {
        ...
        closeItem: function() {
            j && j.height() > 32 && (F.fadeIn(),
            j.find("#portfolio-ajax-single").fadeOut("600", function() {
                e(this).remove()
            }),
            ...
            if (t > 0)
                j.find("img").on("load", function() {
                    ...
                    if (t === a) {
                        ...
                        j.addClass("portfolio-ajax-opened"),
                        F.fadeOut();
                        setTimeout(function() {
                            SEMICOLON.initialize.lightbox(),
                            SEMICOLON.initialize.resizeVideos(),
    ...
    SEMICOLON.widget = {
        ...
        parallax: function() {
            return e.stellar ? void ((X.length > 0 || G.length > 0 || K.length > 0) && (SEMICOLON.isMobile.any() ? (X.addClass("mobile-parallax"),
            G.addClass("mobile-parallax"),
        ...
        masonryThumbsArrange: function(t) {
            return e().isotope ? (SEMICOLON.initialize.setFullColumnWidth(t),
            void t.isotope("layout")) : (console.log("masonryThumbsArrange: Isotope not Defined."),
            !0)
        },
                ...
                t.find("form").validate({
                    submitHandler: function(t) {
                        ...
                        e(t).ajaxSubmit({
                            ...
                            resetForm: !0,
                            success: function(r) {
                                if ("button" == i ? n.html(o) : e(t).find(".form-process").fadeOut(),
                                "inline" == a) {
                                    if ("error" == r.alert)
                                        var l = "alert-danger";
                                    else
                                    ...
                                    s.attr("data-notify-type", r.alert).attr("data-notify-msg", r.message).html(""),
                ...
                t.find("form").validate({
                    submitHandler: function(t) {
                        ...
                        e(t).ajaxSubmit({
                            ...
                            resetForm: !0,
                            success: function(r) {
                                if ("button" == i ? n.html(o) : e(t).find(".input-group-addon").find(".icon-line-loader").removeClass("icon-line-loader icon-spin").addClass("icon-email2"),
                                "inline" == a) {
                                    if ("error" == r.alert)
                                        var l = "alert-danger";
                                    else
                    ...
                    submitHandler: function(t) {
                        ...
                        e(t).ajaxSubmit({
                            ...
                            success: function(r) {
                                ...
                                "button" == i ? n.html(o) : e(t).find(".form-process").fadeOut(),
                                "inline" == a) {
                                    if ("error" == r.alert)
                                        var l = "alert-danger";
                                    else
    ...
    SEMICOLON.documentOnReady = {
        ...
        windowscroll: function() {
            ...
            w.length > 0 && (o = s.length > 0 && !s.hasClass("no-sticky") ? s.hasClass("sticky-style-2") || s.hasClass("sticky-style-3") ? w.offset().top - n.outerHeight() : w.offset().top - s.outerHeight() : w.offset().top);
            ...
            SEMICOLON.header.stickyPageMenu(o),
