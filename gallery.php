    ...
    <?php include_once 'public_html/includes/sideBarContent.php'; ?>
        ...
        <div class="row">
            <?php                             
                ...
                $folderid = $_REQUEST['folderid'];
                $resultcat=mysqli_query($con,"Select * from  `tb_od_folder` where parentFolderId = $folderid order by id desc ");
                ...
                <div class="col-lg-12">
                    ...
                    <?php 
                        ...
                        $photoId = $row['folderId'];
                        $resultPhoto=mysqli_query($con,"Select * from  `td_od_photos` where parentFolderId = $photoId order by id desc ");
                        if ($resultPhoto || mysqli_num_rows($resultPhoto) > 0) {
                        while($photoRow=mysqli_fetch_array($resultPhoto))
                        {
                        ?>                        
                        <div class="col-md-12">
